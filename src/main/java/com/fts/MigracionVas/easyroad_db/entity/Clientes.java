...
@Data
@Entity
@Table(name="easyroad_db.clientes")
public class Clientes implements Serializable{
    ...
    public Clientes(int id, String nombre, String identificacion, String tipoDocumento, String direccion, String telefono, String email, int clienteEstadosId, Date insertTime, Date updateTime, int tipoClienteId, String celular, String ciudad, Integer syncField, String  idFacturacion) {
        this.id = id;
        this.nombre = nombre;
    ...
    public void objectoClientes( ClientesTemp clienteTemp) {
        this.id = clienteTemp.getId();
        this.nombre = clienteTemp.getNombre();
        this.identificacion = clienteTemp.getIdentificacion();
        this.tipoDocumento = clienteTemp.getTipoDocumento();
        this.direccion = clienteTemp.getDireccion();
        this.telefono = clienteTemp.getTelefono();
        this.email = clienteTemp.getEmail();
        this.clienteEstadosId = clienteTemp.getClienteEstadosId();
        this.insertTime = clienteTemp.getInsertTime();
        this.updateTime = clienteTemp.getUpdateTime();
        this.tipoClienteId = clienteTemp.getTipoClienteId();
        this.celular = clienteTemp.getCelular();
        this.ciudad = clienteTemp.getCiudad();
        this.syncField = clienteTemp.getSyncField();
        this.cliente_facturacion_id =  cliente_facturacion_id;
    }
