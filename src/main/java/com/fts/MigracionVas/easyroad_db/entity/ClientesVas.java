...
@Data
@Entity
@Table(name="clientes_vas")
public class ClientesVas implements Serializable{
    ...
    public ClientesVas(Long id, String nombre, String identificacion, String tipoDocumento, String direccion, String telefono, String email, int clienteEstadosId, Date insertTime, Date updateTime, int tipoClienteId, String celular, String ciudad, Integer syncField, String  idFacturacion) {
        this.id = id;
        this.nombre = nombre;
