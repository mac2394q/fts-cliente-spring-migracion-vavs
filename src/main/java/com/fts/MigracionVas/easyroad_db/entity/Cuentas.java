...
@Data
@Entity
@Table(name="easyroad_db.cuentas")
public class Cuentas implements Serializable {
    ...
    public Cuentas( 
            ...
            String clienteId, int cuentaEstadosId, int credito, 
            int saldo, Date insertTime, Date updateTime, String clienteIdentificacion, 
            String descripcionCuenta,int relacion_bolsa,int isBolsa, String contrato
    ) {
    ...
    public Cuentas(int id, String clienteId, int cuentaEstadosId, int credito, 
            int saldo, Date insertTime, Date updateTime, String clienteIdentificacion, 
            String descripcionCuenta,int relacion_bolsa,int isBolsa, String contrato) {
