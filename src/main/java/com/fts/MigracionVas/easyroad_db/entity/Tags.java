...
public class Tags implements Serializable {
    ...
    public Tags(int id, String tagId, int clienteId, String numeroFacial, int cuentaId, int vehiculoId, int tarjetaEstadosId, Date insertTime, Date updateTime, String archivoContrato, String placaVehiculo, int estadoCompra) {
        this.id = id;
        this.tagId = tagId;
